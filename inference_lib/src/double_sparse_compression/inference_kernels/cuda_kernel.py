...
torch.library.impl("doublesparse_cuda::doublesparse_mul_timer", "default", DOUBLESPARSE_CUDA.doublesparse_mul_timer)
torch.library.impl("doublesparse_cuda::doublesparse_mul", "default", DOUBLESPARSE_CUDA.doublesparse_mul)
...
def doublesparse_mul_meta(m, n, k, a_row_offsets, a_col_vals, b_row_offsets, b_col_vals, non_zero_rows, batch_size, x, f, workspace, Y, out):
    return
